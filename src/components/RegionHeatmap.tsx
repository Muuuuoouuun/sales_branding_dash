      ...
      {hoveredRegion && (
        <div className={styles.tooltip} style={tooltipStyle}>
          ...
          <div className={styles.tooltipRow}>
            <span>매출</span>
            <span>${typeof window !== 'undefined' && localStorage.getItem('app-currency') === 'USD' ? '$' : '¥'}{hoveredRegion.revenue.toLocaleString()}M</span>
          </div>
          <div className={styles.tooltipRow}>
            <span>목표</span>
            <span>${typeof window !== 'undefined' && localStorage.getItem('app-currency') === 'USD' ? '$' : '¥'}{hoveredRegion.target.toLocaleString()}M</span>
          </div>
          <div className={styles.tooltipRow}>
            <span>달성률</span>
